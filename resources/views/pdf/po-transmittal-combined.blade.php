...
<body>
    ...
    <div class="page page-break">
        ...
        <div class="recipient">
            @forelse($coaHeaderLines as $line)
            <div>{{ $line }}</div>
            @empty
        ...
        <div class="sign">
            ...
            <br><br><br>
            {{ strtoupper((string) ($coaTransmittal?->signatory_name ?: 'NOEL R. ROCAFORT')) }}<br>
            {{ strtoupper((string) ($coaTransmittal?->signatory_title ?: 'PGDH – GSO')) }}
        </div>
    </div>
    ...
    <div class="page">
        ...
        <div class="recipient normal-weight">
            @forelse($opgHeaderLines as $line)
            <div>{{ $line }}</div>
            @empty
        ...
        <div class="sign">
            ...
            {{ strtoupper((string) (($opgTransmittal?->signatory_name) ?: 'NOEL R. ROCAFORT')) }}<br>
