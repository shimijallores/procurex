...
defineOptions({
    layout: (h, page) => h(Layout, { breadcrumbs: [{ label: 'Roles' }] }, () => page),
})
    ...
    <div class="space-y-6">
        ...
        <div class="grid gap-4 md:grid-cols-3">
            ...
            <Card>
                ...
                <CardContent>
                    <div class="text-2xl font-bold">
                        {{ roles.total > 0 ? Math.round(roles.data.reduce((sum, role) => sum + role.users_count, 0) / roles.total) : 0 }}
                    </div>
                    <p class="text-xs text-muted-foreground">
                        Per role
                    </p>
        ...
        <Card>
            ...
            <CardContent>
                            ...
                            >
                                ...
                                <td class="p-4 align-middle">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span class="text-muted-foreground">{{ role.users_count === 1 ? 'user' : 'users' }}</span>
                                    </div>
                                </td>
                                ...
                                <td class="p-4 align-middle text-right">
                                    <div class="flex items-center justify-end gap-2">
                                        ...
                                        <Button variant="ghost" size="sm" @click="openDeleteModal(role)">
                ...
                <!-- Pagination -->
                <div v-if="roles.last_page > 1" class="mt-4 flex items-center justify-between border-t pt-4">
                    ...
                    <div class="flex items-center gap-1">
                        <template v-for="(link, index) in roles.links" :key="index">
                            ...
                            <span
                                v-else
                                class="inline-flex h-9 w-9 items-center justify-center rounded-md text-sm text-muted-foreground"
                                v-html="link.label"
                            />
                        </template>
                    </div>
