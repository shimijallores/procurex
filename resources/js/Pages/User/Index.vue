...
defineOptions({
    layout: (h, page) => h(Layout, { breadcrumbs: [{ label: 'Users' }] }, () => page),
})
...
<template>
    <div class="space-y-6">
        ...
        <div class="grid gap-4 md:grid-cols-3">
            ...
            <Card>
                <CardHeader class="flex flex-row items-center justify-between space-y-0 pb-2">
                    <CardTitle class="text-sm font-medium">With Offices</CardTitle>
                    ...
                    <table class="w-full caption-bottom text-sm">
                        ...
                        <tbody class="[&_tr:last-child]:border-0">
                            ...
                            >
                                ...
                                <td class="p-4 align-middle">
                                    <div v-if="user.office" class="flex items-center gap-2">
                                        <Icon icon="lucide:building-2" class="h-4 w-4 text-muted-foreground" />
                                ...
                                <td class="p-4 align-middle text-right">
                                    <div class="flex items-center justify-end gap-2">
                                        ...
                                        <Button variant="ghost" size="sm" @click="openDeleteModal(user)">
